...
| [`bimodal-trough-spin.gif`](bimodal-trough-spin.gif) | 360° turntable spin render of the printable model — generated by [`scripts/render_trough_spin.py`](../scripts/render_trough_spin.py). |

![3D turntable spin of the bimodal trough](bimodal-trough-spin.gif)
...
# 360° turntable spin GIF (uses xvfb-run automatically on headless machines)
sudo apt-get install -y openscad xvfb      # one-time
python -m scripts.render_trough_spin       # writes cad/bimodal-trough-spin.gif
```
